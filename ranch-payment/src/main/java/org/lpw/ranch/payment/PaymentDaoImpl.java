...
class PaymentDaoImpl implements PaymentDao {
    ...
    @Override
    public PageList<PaymentModel> query(String type, String user, String orderNo, String tradeNo, int state, Timestamp start, Timestamp end, int pageSize, int pageNum) {
