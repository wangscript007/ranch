...
(
  ...
  c_key VARCHAR(256) NOT NULL COMMENT '类型KEY',
  ...
  c_subject VARCHAR(256) NOT NULL COMMENT '标题',
  c_image VARCHAR(256) DEFAULT NULL COMMENT '主图URI地址',
  c_thumbnail VARCHAR(256) DEFAULT NULL COMMENT '缩略图URI地址',
  ...
  c_audit_remark VARCHAR(256) DEFAULT NULL COMMENT '审核备注',
  c_recycle INT DEFAULT 0 COMMENT '回收站；0-否，1-是',

  PRIMARY KEY pk(c_id) USING HASH,
  KEY k_key(c_recycle,c_audit,c_key,c_time) USING BTREE,
  KEY k_owner(c_recycle,c_audit,c_owner,c_time) USING BTREE,
