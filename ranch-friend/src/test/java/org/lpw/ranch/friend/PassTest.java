...
public class PassTest extends TestSupport {
    ...
    public void pass() {
        ...
        mockCarousel.reset();
        mockCarousel.register("ranch.user.sign", "{\"code\":0,\"data\":{\"id\":\"sign in id\"}}");
        cache.remove(FriendModel.NAME + ".service.owner-friend:sign in idfriend 0");
        mockHelper.reset();
        mockHelper.getRequest().addParameter("friend", "friend 0");
        ...
        Assert.assertEquals("friend 0", friend2.getFriend());
        ...
        FriendModel friend3 = create("friend 0", "sign in id", 0);
        cache.remove(FriendModel.NAME + ".service.owner-friend:sign in idfriend 0");
        cache.remove(FriendModel.NAME + ".service.owner-friend:friend 0sign in id");
        mockHelper.reset();
        mockHelper.getRequest().addParameter("friend", "friend 0");
        ...
        Assert.assertEquals("friend 0", friend4.getFriend());
        ...
        Assert.assertEquals("friend 0", friend5.getOwner());
        Assert.assertEquals("sign in id", friend5.getFriend());
