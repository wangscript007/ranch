...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="ranch.ui.editor.image" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '</form>' +
        ...
        uploadComplete: function(r){
            ...
            try{
                ...
                Base.callback(me.editor, me.dialog, r.substring(r.indexOf('>')+1,r.lastIndexOf('<')), 'SUCCESS');
            }catch (e){
