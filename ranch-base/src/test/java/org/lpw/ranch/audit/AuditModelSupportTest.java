...
public class AuditModelSupportTest extends RecycleModelSupportTest {
    ...
    public void audit() {
        ...
        model1.setAudit(Audit.Pass.getValue());
        model1.setAuditRemark("remark");
        liteOrm.save(model1);
        model2 = liteOrm.findById(TestAuditModel.class, model1.getId());
        Assert.assertEquals(Audit.Pass.getValue(), model2.getAudit());
        ...
        Assert.assertEquals(Audit.Pass.getValue(), object.getIntValue("audit"));
