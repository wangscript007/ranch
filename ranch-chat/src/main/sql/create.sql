DROP TABLE IF EXISTS t_chat_friend;
CREATE TABLE t_chat_friend
(
  c_id CHAR(36) NOT NULL COMMENT '主键',
  c_owner CHAR(36) NOT NULL COMMENT '所有者ID',
  c_friend CHAR(36) DEFAULT NULL COMMENT '好友ID',
  c_note VARCHAR(255) DEFAULT NULL COMMENT '备注',
  c_state INT DEFAULT 0 COMMENT '状态：0-待对方确认；1-待己方确认；2-已通过；3-已拒绝/拉黑',
  c_create DATETIME NOT NULL COMMENT '创建时间',

  PRIMARY KEY pk_chat_friend(c_id) USING HASH,
  KEY k_chat_friend_owner(c_owner) USING HASH
