...
class Service {
    ...
    public menu(): Promise<Menu[]> {
        return this.post('/ui/console/menu');
    }
    ...
    private meta(key: string): Promise<Meta> {
        ...
        return this.post('/ui/console/meta', { key: key }).then(data => this.metas[key] = data);
    }
    ...
    public execute(key: string, header: object = {}, parameter: object = {}, success?: Success): Promise<any> {
        ...
        let promise = this.post('/ui/console/service', header, parameter);
