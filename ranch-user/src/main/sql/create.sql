...
(
  ...
  c_nick VARCHAR(256) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '昵称',
  c_mobile CHAR(11) DEFAULT NULL COMMENT '手机号',
  c_email VARCHAR(256) DEFAULT NULL COMMENT 'Email地址',
  c_portrait VARCHAR(256) DEFAULT NULL COMMENT '头像',
...
(
  ...
  c_uid VARCHAR(256) NOT NULL COMMENT '认证ID',
