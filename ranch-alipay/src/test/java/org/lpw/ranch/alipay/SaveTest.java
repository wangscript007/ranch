...
public class SaveTest extends TestSupport {
    ...
    public void save() {
        ...
        Assert.assertEquals(message.get(Validators.PREFIX + "empty", message.get(AlipayModel.NAME + ".url")), object.getString("message"));

        mockHelper.reset();
        mockHelper.getRequest().addParameter("key", "key");
        mockHelper.getRequest().addParameter("url", generator.random(101));
        mockHelper.mock("/alipay/save");
        object = mockHelper.getResponse().asJson();
        Assert.assertEquals(2605, object.getIntValue("code"));
        Assert.assertEquals(message.get(Validators.PREFIX + "over-max-length", message.get(AlipayModel.NAME + ".url"), 100), object.getString("message"));
        ...
        Assert.assertEquals("url", data.getString("url"));
        ...
        Assert.assertEquals("url", alipay1.getUrl());
        ...
        mockHelper.reset();
        mockHelper.getRequest().addParameter("key", "key");
        mockHelper.getRequest().addParameter("url", "url 1");
        mockHelper.getRequest().addParameter("appId", "app id");
        ...
        Assert.assertEquals(6, data.size());
        Assert.assertEquals("key", data.getString("key"));
        Assert.assertEquals("url 1", data.getString("url"));
        Assert.assertEquals("app id", data.getString("appId"));
        ...
        Assert.assertEquals("key", alipay1.getKey());
        Assert.assertNull(alipay1.getName());
        Assert.assertEquals("url 1", alipay1.getUrl());
        Assert.assertEquals("app id", alipay1.getAppId());
        ...
        mockHelper.getRequest().addParameter("url", "url 2");
        ...
        Assert.assertEquals("url 2", data.getString("url"));
        ...
        Assert.assertEquals("url 2", alipay2.getUrl());
        ...
        mockHelper.getRequest().addParameter("url", "url 3");
        ...
        Assert.assertEquals("url 3", data.getString("url"));
        ...
        Assert.assertEquals("url 3", alipay3.getUrl());
        ...
        mockHelper.getRequest().addParameter("url", "url 4");
        mockHelper.getRequest().addParameter("appId", "app id 3");
        ...
        Assert.assertEquals("url 4", data.getString("url"));
        Assert.assertEquals("app id 3", data.getString("appId"));
        ...
        Assert.assertEquals("url 4", alipay4.getUrl());
